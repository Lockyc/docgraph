...
// ranges. A declaration counts only if its anchor line is in that range's
// added-line set for the file (content read at Head). Findings are deduped by
// (file, line) and sorted.
